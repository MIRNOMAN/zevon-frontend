  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
        <div className="relative w-screen max-w-md bg-white dark:bg-neutral-900 shadow-2xl flex flex-col border-l border-neutral-200 dark:border-neutral-800 animate-in slide-in-from-right duration-300">
          {/* Header */}
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
            {items.length === 0 ? (
              ...
              items.map((item) => (
                <div
                  key={item.id}
                  className="flex gap-4 p-3.5 rounded-2xl bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-100 dark:border-neutral-800/80 transition-all"
                >
                  {/* Thumbnail Placeholder */}
                  <div className="h-20 w-20 rounded-xl bg-neutral-200 dark:bg-neutral-700/60 flex items-center justify-center shrink-0 text-neutral-400 font-bold text-xs uppercase tracking-wider">
                    ZEVON
                  </div>
                  ...
                  <div className="flex-1 flex flex-col justify-between min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-2">
                      ...
                      {/* Quantity Controller */}
                      <div className="flex items-center gap-2 border border-neutral-200 dark:border-neutral-700 rounded-lg px-2 py-0.5 bg-white dark:bg-neutral-900">
                        <button
                          type="button"
          ...
          {items.length > 0 && (
            <div className="border-t border-neutral-200 dark:border-neutral-800 p-6 bg-neutral-50/50 dark:bg-neutral-950/40 space-y-4">
              ...
              <Link
                href="/checkout"
                onClick={onClose}
                className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-neutral-900 dark:bg-white py-3 px-4 text-sm font-bold text-white dark:text-neutral-950 shadow-lg shadow-neutral-900/10 hover:opacity-95 active:scale-[0.99] transition-all"
              >
                Proceed to Checkout
