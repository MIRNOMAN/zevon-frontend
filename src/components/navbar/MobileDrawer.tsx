        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-4 py-3 space-y-2">
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3 rounded-2xl bg-neutral-50/80 dark:bg-neutral-800/40 border border-neutral-100 dark:border-neutral-800 text-sm font-bold text-neutral-800 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors text-left"
            >
              <div className="flex items-center gap-2.5">
                <ShoppingBag className="h-4 w-4 text-neutral-900 dark:text-white" />
                <span>{t("cart.bagTitle", "Shopping Bag")}</span>
              </div>
              <Badge variant="secondary" className="text-xs bg-neutral-900/10 dark:bg-white/10 text-neutral-900 dark:text-white border-transparent">
          ...
          {/* Drawer Footer Actions (Currency, Language, Theme, Profile/Login) */}
          <div className="p-4 border-t border-neutral-200 dark:border-neutral-800 bg-neutral-50/60 dark:bg-neutral-950/40 space-y-3">
            ...
            {isAuthenticated && (
              <Link
                href="/account"
                onClick={onClose}
                className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-neutral-200/70 dark:bg-neutral-800 text-xs font-semibold text-neutral-800 dark:text-neutral-200 hover:bg-neutral-300 dark:hover:bg-neutral-700 transition-colors"
              >
                <User className="h-3.5 w-3.5" />
                <span>{user?.name || t("nav.myProfile", "My Account")}</span>
              </Link>
            )}
